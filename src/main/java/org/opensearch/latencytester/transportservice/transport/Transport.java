...
public interface Transport extends LifecycleComponent {
     ...
     */
    void openConnection(DiscoveryNode node, ConnectionProfile profile, org.opensearch.latencytester.transportservice.action.ActionListener<Connection> listener);
    ...
    interface Connection extends Closeable {
         ...
         */
        void addCloseListener(org.opensearch.latencytester.transportservice.action.ActionListener<Void> listener);
    ...
    final class ResponseHandlers {
        ...
        public TransportResponseHandler<? extends TransportResponse> onResponseReceived(
            ...
            final org.opensearch.latencytester.transportservice.transport.TransportMessageListener listener
        ) {
