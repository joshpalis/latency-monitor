...
package org.opensearch.latencytester.transportservice.common;
...
public final class ThreadContext implements Writeable {
    ...
    public Runnable preserveContext(Runnable command) {
        ...
        if (command instanceof AbstractRunnable) {
            return new ContextPreservingAbstractRunnable((org.opensearch.latencytester.transportservice.common.AbstractRunnable) command);
        }
     ...
     */
    private class ContextPreservingAbstractRunnable extends org.opensearch.latencytester.transportservice.common.AbstractRunnable implements WrappedRunnable {
        private final org.opensearch.latencytester.transportservice.common.AbstractRunnable in;
        private final StoredContext creatorsContext;

        private StoredContext threadsOriginalContext = null;

        private ContextPreservingAbstractRunnable(org.opensearch.latencytester.transportservice.common.AbstractRunnable in) {
        ...
        @Override
        public org.opensearch.latencytester.transportservice.common.AbstractRunnable unwrap() {
            return in;
        }
    }
