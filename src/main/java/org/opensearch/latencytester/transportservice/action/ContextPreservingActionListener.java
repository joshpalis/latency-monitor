...
import org.opensearch.latencytester.transportservice.common.ThreadContext;
...
public final class ContextPreservingActionListener<R> implements ActionListener<R> {
     ...
     */
    public static <R> ContextPreservingActionListener<R> wrapPreservingContext(ActionListener<R> listener, org.opensearch.latencytester.transportservice.common.ThreadContext threadContext) {
