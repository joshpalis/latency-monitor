...
import org.opensearch.latencytester.transportservice.ClusterSettingsResponseHandler;
import org.opensearch.latencytester.transportservice.ClusterStateResponseHandler;
import org.opensearch.latencytester.transportservice.ExtensionSettings;
import org.opensearch.latencytester.transportservice.LocalNodeResponseHandler;
...
public class ExtensionsRunner {
    ...
    PluginResponse handlePluginsRequest(PluginRequest pluginRequest) {
        ...
        PluginResponse pluginResponse = new PluginResponse("Named Writeable Registry");
